...
|---|---|---|---|
| `MOVIE` | 영화 | POINT_IN_TIME | ✅ |
| `CONCERT` | 콘서트 | POINT_IN_TIME | ✅ |
| `SPORTS` | 스포츠 | POINT_IN_TIME | ✅ |
| `EXHIBITION` | 전시·팝업 | DATE_RANGE | ✅ |
| `TRAIN` | 기차 | POINT_IN_TIME | ❌ |
| `FLIGHT` | 항공 | POINT_IN_TIME | ❌ |
| `HOTEL` | 호텔 | DATE_RANGE | ❌ |
| `GIFTICON` | 기프티콘 | EXTENDABLE | ❌ |
